...
<body>
	...
	<div class="container">
	<h3 class="text-uppercase text-center my-5">Đăng nhập tài khoản admin
    <form action ="xulyadmin.php" method= "post" >
		Username: <input type="text" name="username" class='form-control' required="">
		Password: <input type="password" name="password" class='form-control' required="">
		<input type="submit" class="btn btn-block btn-info">
	</form>
    <button onclick="openForm()">Đăng ký admin</button>
...
<div id="myForm" style="display:none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: #f9f9f9; padding: 20px; border: 1px solid #ccc; box-shadow: 0px 0px 10px 0px #000000;" >
    <form action="processadmin.php" method="post" style="text-align: center;">
